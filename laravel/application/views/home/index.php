...
<head>
	...
	<link rel="stylesheet" href="//micoranime.sytes.net/css/micoranime.css?123">
...
<body>
<script src="//micoranime.sytes.net/js/modernizr.custom.50576.js"></script>
 <div id='fb-root'></div>
	...
	<header>
		<h1 class="blogo"><a href="http://micoranime.sytes.net">Mi Corazón Anime, Mi Mundo Otaku</a></h1>
	</header>
	<section class="docroot">
		<section class="blposts">
			...
			<section class="blpost limit">
				...
				<aside>
					<div href="#like" class="like_button" title="Me gusta"><i class="icon"></i>(Like)</div>
					<div href="#favo" class="fav_button" title="Añadir a favoritos"><i class="icon"></i>Añadir a favoritos</div>
	...
	<script>
		$(".like_fb_button").on("click",function(e){
			var origin = {
				...
				redirect_uri:"http://micoranime.sytes.net/facebook",
